...
<body class="sidebar-fixed sidebar-dark header-light header-fixed" id="body">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer mt-auto">
                <div class="copyright bg-white">
                    <p>
                        &copy; <span id="copy-year">2019</span> Copyright Sleek Dashboard Bootstrap Template
                    </p>
                </div>
                <script>
                    var d = new Date();
    ...
    <script src="{{ asset('backend/assets/plugins/jquery-mask-input/jquery.mask.min.j') }}s"></script>
